    ...
    QSplashScreen(pixmap, f)
{
	...
	QString copyrightText3  = QChar(0xA9)+QString(" 2013-2014 ") + QString(tr("The BitQuark developers"));
	QString copyrightText4  = QChar(0xA9)+QString(" 2014-2015 ") + QString(tr("The BitCrystalX developers"));
	...
	pixPaint.drawText(newPixmap.width()-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpace+36,copyrightText4);

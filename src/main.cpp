...
uint256 hashGenesisBlock("0x00000cf6a3fbb905c50857817d55ab63969df1ef77ab0d0e339ef27cb1e0ecea");
static const unsigned int timeGenesisBlock = 1428511096;
...
const string strMessageMagic = "BitCrystalX Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000cf6a3fbb905c50857817d55ab63969df1ef77ab0d0e339ef27cb1e0ecea");
    }
...
*/
        ...
        const char* pszTimestamp = "Feb 25th 2015. Phones can be tracked by battery use. Fck!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xf7d696ea74415ac883ec77d79ded2da449e5b164d31ef5b5d3329964e92b0b44"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BitCrystalXMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BitCrystalXMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BitCrystalXMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("BitCrystalX-miner");
    ...
    try { loop {
        ...
        printf("Running BitCrystalXMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("BitCrystalXMiner terminated\n");
        throw;
    }
}

...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        horizontalLayout = new QHBoxLayout(frameMain);
        ...
        label_wallet_bgcoin = new QLabel(frameMain);
        ...
        label_wallet_bgcoin->setIndent(-1);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "<html><head/><body><p>The displayed information may be out of date. Your wallet automatically synchronizes with the BitCrystal network after a connection is established, but this process has not completed yet.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP

...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        tabWidget->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
        ...
        numberOfCoins = new QLabel(tab_info);
        numberOfCoins->setObjectName(QString::fromUtf8("numberOfCoins"));
        numberOfCoins->setCursor(QCursor(Qt::IBeamCursor));
        numberOfCoins->setTextFormat(Qt::PlainText);
        numberOfCoins->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout->addWidget(numberOfCoins, 13, 1, 1, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "BitCrystal - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        label_9->setText(QApplication::translate("RPCConsole", "BitCrystal Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "<html><head/><body><p>Open the BitCrystal debug log file from the current data directory. This can take a few seconds for large log files.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "<html><head/><body><p>Show the BitCrystal-Qt help message to get a list with possible BitCrystal command-line options.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        showCLOptionsButton->setText(QApplication::translate("RPCConsole", "&Show", 0, QApplication::UnicodeUTF8));
        label_15->setText(QApplication::translate("RPCConsole", "Money Supply", 0, QApplication::UnicodeUTF8));
        numberOfCoins->setText(QApplication::translate("RPCConsole", "N/A", 0, QApplication::UnicodeUTF8));

...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QString::fromUtf8("Copyright &copy; 2009-YYYY The Bitcoin developers, 2013 The Quarkcoin developers, 2013-2014 The BitQuark developers, 2014 The BitCrystalEx developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BitCrystal", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">BitCrystal</span> version</p></body></html>", 0, QApplication::UnicodeUTF8));
